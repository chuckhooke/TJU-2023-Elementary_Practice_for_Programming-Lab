...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String remoteHome = "C:\\Users\\hkhk3\\Desktop\\Java\\project\\assignment\\src\\com\\huawei\\classroom\\student\\h62\\test/";
			MyDaemonConfigVo config = new MyDaemonConfigVo();
			// 根目录在什么地方
			config.setRoot(remoteHome);
			// 监听端口号
			config.setPort(9999);
			// 存放了用户名 口令 的认证数据文件
			config.setPasswordFile("C:\\Users\\hkhk3\\Desktop\\Java\\project\\assignment\\src\\com\\huawei\\classroom\\student\\h62\\my_user.txt");
			// 构造我的监听类
			MyDaemon daemon = new MyDaemon(config);
			// 启动
			daemon.start();
			
			System.out.println("第1步 启动远程daemon 完成 !");
